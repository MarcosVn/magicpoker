var Poker = (function () {
  ...
  return {
    ...
    updateBlinds: function (round) {
      ...
      jQuery('.small-blind').html(round_blinds.small);
      jQuery('.big-blind').html(round_blinds.big);
      /* Ao atualizar na tela do servidor, enviar a aposta para o cliente */
      socket.emit('blinds-update', round_blinds);
    },
    updateClock: function (timer) {
      ...
      jQuery('.clock').html(minute + ":" + second);
    ...
    updatePlayPauseButton: function () {
      var pause_play_button = jQuery('#poker_play_pause a');
